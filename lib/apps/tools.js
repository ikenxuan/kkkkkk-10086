...
import { ParseCoordinator } from '../module/utils/ParseCoordinator.js';
...
const createMessageParseIdentity = (platform, e) => {
...
export class kkkTools extends plugin {
    ...
    async runCoordinatedParse(e, platform, businessName, fn) {
        const pluginContext = this;
        ...
        try {
            const result = await parseCoordinator.submit(createMessageParseIdentity(platform, e), () => handler(e), reaction);
