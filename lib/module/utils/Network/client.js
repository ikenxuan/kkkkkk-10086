...
import { attemptDownloadStream } from './download-pipeline.js';
...
export class Networks {
    ...
    async attemptDownloadStream(progressCallback, retryCount, options) {
        return await attemptDownloadStream({
            ...
            retry: async (nextRetryCount, nextOptions) => await this.downloadStream(progressCallback, nextRetryCount, nextOptions)
        }, progressCallback, retryCount, options);
    }
}
