...
import { DEFAULT_SLOW_FLOOR_BYTES, DEFAULT_SUSTAIN_MS, SAMPLE_INTERVAL_MS } from './DownloadWatchdog.js';
 ...
 */
const normalizeLiveStreamDuration = (value) => typeof value === 'number' && Number.isFinite(value) && value > 0
    ? value
 ...
 */
export const externalMinBytes = (uploadConfig) => {
