...
import { buildEventContextLogEntries, toErrorCardPlatform } from './ErrorHandler/render.js';
...
const buildApiErrorImage = async (platform, method, err, event) => {
    ...
    const contextEntries = buildEventContextLogEntries(messageEvent);
