 ...
 */
export const getDouyinData = async (method, arg1, arg2, dependencies = getDefaultDependencies()) => {
    ...
    return await withApiCache({ platform: 'douyin', method, cookie, options }, async () => await softFetch(async () => await runWithRequestGuard(async (signal) => await fetcher(options, cookie, {
        ...buildRequestConfig(),
        signal
    }), {
