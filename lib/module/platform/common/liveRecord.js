import { Base, Common, Config, baseHeaders, needsGroupFileChannel, sanitizeFilenameSegment, uploadFile } from '../../../module/utils/index.js';
...
/** 抖音：链接 -> 直播间 -> flv 档位 */
const resolveDouyinSource = async (url) => {
...
/** B站：链接 -> 房间号 -> playurl */
const resolveBilibiliSource = async (url) => {
