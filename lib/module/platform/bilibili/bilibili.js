...
import { buildBilibiliArticleRichText, buildBilibiliRichTextForwardNodes, formatBilibiliDynamicText, formatBilibiliVideoDescText, getHotBilibiliDanmaku, getUsernameMetadata } from './dynamicText.js';
                ...
                case 'dynamic_info': {
                    ...
                    switch (dynamicInfo.data.data.item.type) {
                        ...
                        case DynamicType.DRAW: {
                            ...
                            await this.e.reply(await Render('bilibili/dynamic/DYNAMIC_TYPE_DRAW', {
                                ...
                                text: dynamicInfo.data.data.item.modules.module_dynamic.major
                                    ? replacetext(br(dynamicInfo.data.data.item.modules.module_dynamic.major.opus?.summary?.text || ''), dynamicInfo.data.data.item.modules.module_dynamic.major.opus?.summary?.rich_text_nodes || [])
                                    : '',
                        ...
                        case DynamicType.WORD: {
                            ...
                            Config.bilibili.bilibilinumcomments && commentsData && await this.e.reply(await Render('bilibili/comment', {
                                Type: '动态',
