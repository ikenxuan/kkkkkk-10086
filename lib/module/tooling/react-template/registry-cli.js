...
import { parseTemplateToolCliArguments } from "./cli-options.js";
import { checkTemplateRegistry, syncTemplateRegistry } from "./registry-generator.js";
const repositoryRoot = resolve(dirname(fileURLToPath(import.meta.url)), '../../../..');
const { root, check } = parseTemplateToolCliArguments(process.argv.slice(2), repositoryRoot, { allowCheck: true });
if (check) {
