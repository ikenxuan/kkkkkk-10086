...
import { divider, group, num, radio, select, sw } from '@/module/guoba/helpers'
import { sendContentOptions, videoQualityOptions } from '@/module/guoba/shared'

import type { GuobaSchema } from '@/types/guoba'

export const xiaohongshu: GuobaSchema[] = [
  group('小红书配置'),
  divider('小红书解析'),
