/** 快手 GraphQL 请求描述 */
export interface KuaishouApiRequest {
  type: string
  url: string
  body: {
...
class KuaishouAPI {
  单个作品信息 (photoId: string | undefined): KuaishouApiRequest {
    return {
  ...
  作品评论信息 (photoId: string | undefined): KuaishouApiRequest {
    return {
